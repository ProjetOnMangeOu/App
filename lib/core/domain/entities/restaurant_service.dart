...
class RestaurantService {
  ...
  RestaurantService update(Map<String, dynamic> data, CacheAPI cacheAPI) {
    _name = data['name'];
    _details = List<String>.from(data['details']);
    cacheAPI.writeRestaurantServiceSync(restaurantService: this);
    return this;
  }
}
